...
const AboutUs = () => {
    return (
        <div className="bg-sky-100">
            ...
            {/* Page title  */}
            <div className="login-page-banner text-white about-bottom-banner">
            ...
            <div className="container m-auto full-width-all py-24 px-2">
                <div className=" ">
                    ...
                    <div className="py-16 shadow-xl  bg-white mb-24 p-4 rounded-lg">
                        <h1 className="text-4xl font-semibold text-sky-800 ">  Fashion Zone Watch Company LTD.</h1>
                    ...
                    <div>
                        ...
                        <div className="shadow-xl  bg-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4  rounded-lg">
                            <div className="pb-24 pt-16 p-4 lg:col-span-7 ">
                                <h1 className="text-4xl mb-8 font-semibold text-sky-800 ">Time will make your life...</h1>
                        ...
                        <div className="my-24">
                            <h1 className="text-4xl mb-8 text-center font-semibold text-sky-800 ">Our Values</h1>
