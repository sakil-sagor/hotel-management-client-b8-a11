...
const Navbar = () => {
    ...
    return (
        <div className={` sticky top-0 border-b shadow-lg shadow-blue-200  z-[9999] ${darkMode ? "bg-gray-500 text-white" : "bg-sky-50 text-black"}`}>
            <div className='py-4 container mx-auto px-2'>
                            ...
                            <li className='ml-2 mt-10 md:mt-0 active border md:border-0  nav-bg profile-holder' >
                                {
                                    user?.email || user?.displayName ?
                                        ...
                                        :
                                        < NavLink className="py-2  bg-sky-600  hover:text-pink-800  rounded-md" to="/registration">   <span className="block py-2">LogIn</span> </NavLink >
                                }
                ...
                <div className='md:hidden'>
                    <ul className={` fixed text-center space-y-5 text-white duration-1000 pr-2 top-20 mt-1 h-screen  w-3/4 opacity-95 bg-green-900  ${!open ? " left-0" : "left-[-800px] "}`}>
