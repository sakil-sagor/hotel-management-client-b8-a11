...
const AllRooms = () => {
    ...
    return (
        <div>
            <div className="py-4">
                <h2 className="text-sky-800 font-semibold text-2xl "><AiFillDatabase className="inline mb-1"></AiFillDatabase> All Rooms: </h2>
                    ...
                    total ?
                        <>
                            ...
                            <div className=' mb-16  flex items-center mt-8' >
                                ...
                                <div>
                                    {
                                        [...Array(count).keys()].map(number => <button className={`${page === number ? "bg-sky-700 " : " bg-gray-500"} text-white rounded  mr-4 py-1 px-4`} key={number} onClick={() => setPage(number)}>{number + 1}</button>)
                                    }
                                </div>
